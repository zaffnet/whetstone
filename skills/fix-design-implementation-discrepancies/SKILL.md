...
4. For each discrepancy, ask the user whether the docs/schema should change to match the PR or the PR should change to match the docs/schema. Ask every question in this workflow with AskUserQuestion, and keep asking follow-ups until the intended resolution is clear.
