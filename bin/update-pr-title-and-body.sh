...
if grep -Eiq '^- \[x\] (Design docs reflect|The design doc has been updated)' <<<"$CURRENT_BODY"; then
  DESIGN_CHECKBOX='[x]'
fi

if grep -Eiq '^- \[x\] If this PR was generated by AI' <<<"$CURRENT_BODY"; then
  AI_CHECKBOX='[x]'
fi
...
- $DESIGN_CHECKBOX Design docs reflect the code changes.
- $AI_CHECKBOX If this PR was generated by AI, the **AI Generated** label is applied.
EOF
)
