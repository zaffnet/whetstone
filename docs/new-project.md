...
| `use_graphify` | Adds query-first graphify guidance to `AGENTS.md`, a `PreToolUse` hook in `.claude/settings.json`, a Codex hook entry, and `.cursor/rules/graphify.mdc` |
